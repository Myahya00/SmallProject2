...
public class StepNotice {
    ...
    @Given("^Open the chrome and goto legal notice website$")
    public void Open_the_chrome_and_goto_legal_notice_website() throws Throwable {
    ...
    @When("^Click box and click legal notice$")
    public void Click_box_and_click_legal_notice() throws Throwable {
